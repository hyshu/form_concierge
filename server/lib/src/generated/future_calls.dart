...
import '../future_calls/daily_notification_future_call.dart' as _i4;
...
class FutureCalls extends _i1.FutureCallDispatch<_FutureCallRef> {
  ...
  void initialize(
    ...
    var registeredFutureCalls = <String, _i1.FutureCall>{
      'DailyNotificationInvokeFutureCall': DailyNotificationInvokeFutureCall(),
    };
...
class _FutureCallRef {
  ...
  late final dailyNotification = _DailyNotificationFutureCallDispatcher(
    _invokeFutureCall,
  );
}

class _DailyNotificationFutureCallDispatcher {
  _DailyNotificationFutureCallDispatcher(this._invokeFutureCall);
...
class DailyNotificationInvokeFutureCall
    extends _i1.FutureCall<_i2.NotificationSettings> {
  @override
