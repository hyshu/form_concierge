...
CREATE TABLE "admin_user" (
    ...
    "canCreateSurveys" boolean NOT NULL DEFAULT true,
    "createdAt" timestamp without time zone NOT NULL DEFAULT CURRENT_TIMESTAMP
);

-- Indexes
CREATE UNIQUE INDEX "user_id_unique" ON "admin_user" USING btree ("userId");
...
--
-- Class NotificationSettings as table notification_settings
--
...
CREATE TABLE "survey" (
    ...
    "authRequirement" text NOT NULL DEFAULT 'anonymous'::text,
...
-- Indexes
CREATE UNIQUE INDEX "slug_unique" ON "survey" USING btree ("slug");
CREATE INDEX "status_index" ON "survey" USING btree ("status");

--
-- Class SurveyResponse as table survey_response
--
...
-- Indexes
CREATE INDEX "survey_submitted_index" ON "survey_response" USING btree ("surveyId", "submittedAt");
CREATE INDEX "user_survey_index" ON "survey_response" USING btree ("userId", "surveyId");
...
--
-- Foreign relations for "notification_settings" table
--
...
--
-- Foreign relations for "survey_response" table
--
ALTER TABLE ONLY "survey_response"
    ADD CONSTRAINT "survey_response_fk_0"
    FOREIGN KEY("surveyId")
    REFERENCES "survey"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
