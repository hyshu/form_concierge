...
class AnswerUpdateTable extends _i1.UpdateTable<AnswerTable> {
  ...
  _i1.ColumnValue<List<int>, List<int>> selectedOptionIds(List<int>? value) =>
      _i1.ColumnValue(
        table.selectedOptionIds,
        value,
      );
}
...
class AnswerTable extends _i1.Table<int?> {
  AnswerTable({super.tableRelation}) : super(tableName: 'answer') {
    ...
    selectedOptionIds = _i1.ColumnSerializable<List<int>>(
      'selectedOptionIds',
      this,
    );
  }
  ...
  /// Selected option IDs (for choice questions)
  late final _i1.ColumnSerializable<List<int>> selectedOptionIds;
