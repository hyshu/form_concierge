  ...
  Component build(context) => div(
    ...
    [
      div(
        ...
        [
          span(classes: 'text-red-500 text-2xl', [Component.text('\u26A0')]),
        ],
      ),
      h2(classes: 'mt-5 text-xl font-semibold text-slate-900', [
        Component.text(FormContentMessages.text(locale, 'somethingWentWrong')),
      ]),
      p(classes: 'mt-2 text-slate-600', [Component.text(message)]),
      if (onRetry != null)
        div(classes: 'mt-6', [
          button(
